...
import { savePengeluaran } from "@/lib/actions";
import { SubmitBtn } from "./buttons";

const CreatePengeluaranForm = () => {
  const [state, formAction] = useFormState(savePengeluaran, null);
  return (
    <div>
...
export default CreatePengeluaranForm;
